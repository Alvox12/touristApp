...
class CustomPlaceListViewModel : ViewModel() {
   ...
   * mayor numero de preferencias que coincidan con los gustos del usuario*/
    ...
    * y sirve para comprarar las puntuaciones de los lugares y ordenarlas en funcion de las mismas*/
    ...
    /**Descarga los IDs de los lugares pertenecientes a la lista*/
    ...
    /**Descarga mas lugares de la base de datos hasta descargar el maximo permitido o descargar todos
     * los de la lista*/
    fun loadNewData() {
